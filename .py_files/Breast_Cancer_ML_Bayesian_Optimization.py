...
# Function II: Define a hyperparameter searching space of a machine learning model.
def searching_space(model_name):
    '''
    Input:
        model_name: a string variable. Currently supports 'GradientBoostingClassifier', and 'XGBClassifier'.

    Output:
        Return a dictionary object containing hyperparameters' ranges of a machine learning model.
    '''
...
# Function III: Define the objective function returned by Gradient Boosting Tree for the Bayesian optimization.
...
# Function IV: Define the objective function returned by Extreme Gradient Boosting Tree for the Bayesian optimization.
...
# Function V: Perform Bayesian Optimization on a machine learning model to find the best hyperparameter setting.
def bayesian_optimize(model_name, n_eval):
    '''
    Inputs:
        model_name: a string variable. Currently supports 'GradientBoostingClassifier', and 'XGBClassifier'.
        n_eval: an integer variable to specify number of iterations.

    Outputs:
        best: return the best model performance and a set of hyperparameters to acheive it.
        trials: a trail object storing previous searching results which can be used for a continued Bayesian Optimization.
    '''
 ...
 # Function VI: Perform continued Bayesian Optimization based on previous searching results on a machine learning model.
def continue_bayesian_optimization(trail, model_name, n_eval):
    '''
    Inputs:
        trail: a trail object storing previous Bayesian Optimization searching results.
        model_name: a string variable. Currently supports 'GradientBoostingClassifier', and 'XGBClassifier'.
        n_eval: an integer variable to specify number of iterations.
